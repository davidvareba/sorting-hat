...
const buttons = () => {
    ...
    <button type="button" class="btn btn-start" id="start">Let's Start Sorting</button>
    <button type="button" class="btn btn-sort" id="sort" >Sort</button>
    <button type="button" class="btn btn-hermione" id="expelHermione" >Expel</button>
    <button type="button" class="btn btn-harry" id="expelHarry>Expel</button>
    <button type="button" class="btn btn-luna" id="expelLuna" >Expel</button>
    `;
};
